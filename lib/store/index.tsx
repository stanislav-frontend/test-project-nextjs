  ...
  initPersist = () => {
    const stores = 
      Object.getOwnPropertyNames(this)
            ...
            .filter((store) => Object.getOwnPropertyNames(this[store as keyof typeof this]).includes('initPersist'));
    stores.forEach(store => (this[store as keyof typeof this] as PersistedStore).initPersist());
  }
}